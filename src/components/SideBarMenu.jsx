                    ...
                    <ul id="nav-menu" className="nav-menu">
                        <li>
                            <Link
                                ...
                                <span className="mx-4 link-label">Dashboard</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                                ...
                                <span className="mx-4 link-label">UI Elements</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                                ...
                                <span className="mx-4 link-label">Tables</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                                ...
                                <span className="mx-4 link-label">Forms</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                                ...
                                <span className="mx-4 link-label">Cards</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                                ...
                                <span className="mx-4 link-label">Modal</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                                ...
                                <span className="mx-4 link-label">Blank</span>
                            </Link>
                        </li>
                    </ul>
                </nav>
